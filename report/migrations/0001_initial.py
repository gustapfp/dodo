...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "data_management",
            "0006_remove_formsubsectionanswered_answered_questions_and_more",
        ),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "answered_questions_level_1",
                    models.ManyToManyField(
                        related_name="answered_questions_level_1",
                        to="report.questionanswer",
                    ),
                ),
                (
                    "answered_questions_level_2",
                    models.ManyToManyField(
                        related_name="answered_questions_level_2",
                        to="report.questionanswer",
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="answered_questions_level_3", to="report.questionanswer"
            ),
        ),
        migrations.AddField(
            model_name="formsectionanswered",
            ...
            field=models.ManyToManyField(
                related_name="answered_subsections", to="report.formsubsectionanswered"
            ),
        ),
        migrations.AddField(
            model_name="formsectionanswered",
